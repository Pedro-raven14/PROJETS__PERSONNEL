            ...
            <tbody>
              {topMots.map(({ mot, count, pourcentage }) => (
                <tr key={mot} className="border-b border-[#1e1e1e] last:border-0">
                  <td className="py-2 pr-4 font-semibold">{mot}</td>
                  <td className="py-2 pr-4">{count}</td>
                  <td className="py-2">
                    <div className="flex items-center gap-2">
                      {/* Barre de progression visuelle */}
                      <div className="w-16 sm:w-32 h-2 bg-[#272727] rounded-full overflow-hidden">
                        <div
