import { LayoutDashboard, Book, Settings, ChevronDown, User, FileText, LogOut } from 'lucide-react';
import React, { useEffect, useRef, useState } from 'react'
import logo from '../../assets/insigne.png';
import { useNavigate, NavLink } from 'react-router-dom';

type SidebarFormateurProps = {
  isOpen?: boolean;
  onClose?: () => void;
};
...
const SidebarFormateur = ({ isOpen = true, onClose }: SidebarFormateurProps) => {
  const menu = [
        {
