...
const BudgetSlider = ({ cat, depense, budget, onChange }) => {
  const pct =
    budget > 0 ? Math.min(Math.round((depense / budget) * 100), 100) : 0;
...
const Parametres = () => {
  ...
  transactions
    ...
    .forEach((t) => {
      depensesMap[t.categorie] = (depensesMap[t.categorie] ?? 0) + t.montant;
    });
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Personnalisez votre expérience Budget Tracker.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mb-5 text-sm text-slate-400">
              Définissez une limite pour chaque catégorie.
            </p>
